...
Geocode.setApiKey("AIzaSyAeWwZ3gDRU13z6jiQRTuhFkA3ugQG_Q7Q");
Geocode.enableDebug();
class Map1 extends React.Component {
  ...
  /**
    ...
    */
  componentDidUpdate() {
    this.props.handleMapDetails(this.state);
  }
  componentDidMount() {
  ...
  /**
    ...
    */
  onChange = (event) => {
    console.log("JIJIJIJIJIIJIJIJIJJJIIIIIIIIII");
    this.setState({ [event.target.name]: 'hardik' });
    this.props.get(event);
  };
  /**
