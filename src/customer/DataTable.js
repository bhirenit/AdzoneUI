...
const headCells = [
  { id: 'id', numeric: true, disablePadding: true, label: 'Product Id' },
  { id: 'mediaType', numeric: false, disablePadding: true, label: 'Media Type' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.sizex} X {row.sizey}</TableCell>
                      <TableCell align="center">{row.location}</TableCell>
                      <TableCell align="center">{row.city}</TableCell>
                      <TableCell align="center">{row.ratePerMonth}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
